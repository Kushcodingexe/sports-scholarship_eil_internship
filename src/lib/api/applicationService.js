...
const API_URL = 'https://sports-scholarshipeilinternship-production.up.railway.app/api/applications';
...
const checkServerStatus = async () => {
  try {
    const response = await fetch('https://sports-scholarshipeilinternship-production.up.railway.app', { 
      method: 'GET',
      timeout: 2000,
      headers: {
